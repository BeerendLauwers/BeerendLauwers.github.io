---
title: Getting a DS4243 and LSI 9300-8e HBA working on unRAID
---

There's 24 drives in a DS4243 I want to expose to unRAID.
...
On [this download page](https://www.broadcom.com/products/storage/host-bus-adapters/sas-9300-8e#downloads), it's under "Firmware", `Installer_P14_for_Linux`, which is supposed to be generic for all x64 Linux.

Download it and stick it on a USB stick that goes into the server.

You'll have to manually mount it with `mount /dev/sdX /mnt/usb`.
(You'll have to `mkdir /mnt/usb` first.)
...
[Someone else has written a pretty good guide for this](https://amussey.github.io/2015/02/19/updating-LSI-9201-16i-firmware.html).
